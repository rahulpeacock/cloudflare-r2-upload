...
export function Loading({ width = 24, height = 24, dur = '0.75s' }: SVGProps<SVGElement>): JSX.Element {
  return (
    <svg className='fill-current' width={width} height={height} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
      <title> </title>
